...
| 16 | 57.334 | phase81 (`2598f96`) | 同Deep ResearchのRCL(restricted candidate list)方式リスタート。配置率+0.25pp。主枠には採用せず(#15をわずかに下回る、Phase82で組み合わせ・パラメータ深掘り中) |

```mermaid
xychart-beta
    title "提出スコアの推移(#12・#13・#14は不採用だった変種、主枠は#15の57.394)"
    x-axis ["baseline", "phase4", "phase6", "phase7", "phase8", "phase9", "phase15", "phase19", "phase25a", "phase70", "phase71", "phase73", "phase78/80", "p81 dftrc", "p81 cutcorner", "p81 rcl"]
    y-axis "SIGNATE提出スコア" 0 --> 60
    line [16.94, 24.01, 31.26, 37.31, 40.18, 42.47, 50.25, 51.00, 53.64, 56.05, 57.18, 54.80, 55.68, 54.567, 57.394, 57.334]
```
...
チューニングし尽くした」という閉塞は、外部の学術文献という新しい情報源を入れることで再び開いた
形です。Phase82では#15と#16の組み合わせ・パラメータの深掘りを実施中です
(`results/phase81_report.md`、`results/phase82_report.md`)。
